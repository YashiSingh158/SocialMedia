...
import com.socialmedia.service.JwtTokenService;
...
public class UserController {
    ...
    public ResponseEntity<?> signup(@RequestBody @Valid SignupDto signupDto) {
        Users savedUser = userService.createNewUser(signupDto);
    ...
    public ResponseEntity<?> login(@RequestBody @Valid LoginDto loginDto) {
        ...
        Users loginUser = userService.getUserByEmail(loginDto.getEmail());
    ...
    public ResponseEntity<?> showUserProfile(Authentication authentication) {
        Users user = userService.getUserByEmail(authentication.getPrincipal().toString());
    ...
    public ResponseEntity<?> updateUserInfo(@RequestBody @Valid UpdateUserInfoDto updateUserInfoDto) {
        Users updatedUser = userService.updateUserInfo(updateUserInfoDto);
    ...
    public ResponseEntity<?> updateProfilePhoto(@RequestParam("profilePhoto") MultipartFile profilePhoto) {
        Users updatedUser = userService.updateProfilePhoto(profilePhoto);
        return new ResponseEntity<>(updatedUser, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> updateCoverPhoto(@RequestParam("coverPhoto") MultipartFile coverPhoto) {
        Users updatedUser = userService.updateCoverPhoto(coverPhoto);
        return new ResponseEntity<>(updatedUser, HttpStatus.OK);
    }
