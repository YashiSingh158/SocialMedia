...
public class PostController {
    ...
    public ResponseEntity<?> getPostLikes(@PathVariable("postId") Long postId,
        ...
        List<Users> postLikerList = userService.getLikesByPostPaginate(targetPost, page, size);
    ...
    public ResponseEntity<?> getCommentLikeList(@PathVariable("commentId") Long commentId,
        ...
        List<Users> commentLikes = userService.getLikesByCommentPaginate(targetComment, page, size);
